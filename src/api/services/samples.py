...
class AudioTrack:
    ...
    def add_at(self, instant: Time, samples: np.ndarray) -> None:
        """
        Adding new samples to existing track at any given time instance
        of the original track.

        Samples are either
            Appended to increase original track content duration
            Interfered with current track to create new track with modified sound
        """
